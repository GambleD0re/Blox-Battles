...
// [MODIFIED] The API_BASE_URL now dynamically uses the production URL when available.
// In development, import.meta.env.VITE_API_BASE_URL will be undefined, so it will default to '/api', using the proxy.
// In a production build, it will use the full URL from your .env.production file.
